      ...
      <div className="container mx-auto h-full">
        <div className="flex flex-col xl:flex-row items-center justify-between pt-5 xl:pt-8 xl:pb-24">
          ...
          <div className="text-center xl:text-left order-2 xl:order-none">
            <span className="text-xl text-tertiary">Software Developer</span>
            ...
            <Link href="./cv.pdf" download="cv">
              ...
              <div className="mb-8 xl:mb-0">
                <Social containerStyles="flex gap-6" iconStyles="w-9 h-9 border-2 border-primary rounded-full flex justify-center items-center text-primary text-base hover:text-[white] hover:bg-primary trasition-all duration-500"/>
              </div>
